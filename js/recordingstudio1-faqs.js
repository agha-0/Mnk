...
const studioFaqs = [
    ...
    },
    {
        ...
        answers: [
            "Patch & Inserts: Centralized routing for quick hardware inserts and clean re-patching.",
            "Balanced I/O: Fully balanced signal path with studio-grade headroom and low-noise cabling.",
            "Tie Lines: Dedicated room-to-room connectivity for fast mic/line runs and repeatable setups.",
        ],
    },
    {
